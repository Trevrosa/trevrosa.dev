...
function configureGame() {
  ...
  redc = [
    50,
    colorPalette[player1color.pickerText][0],
    colorPalette[player2color.pickerText][0],
    140,
  ];
  greenc = [
    50,
    colorPalette[player1color.pickerText][1],
    colorPalette[player2color.pickerText][1],
    140,
  ];
  bluec = [
    50,
    colorPalette[player1color.pickerText][2],
    colorPalette[player2color.pickerText][2],
    140,
  ];
}
...
function play() {
  ...
  player1buttons.option =
    player1buttons.buttons[player1buttons.currentOption].btext;
  player2buttons.option =
    player2buttons.buttons[player2buttons.currentOption].btext;
