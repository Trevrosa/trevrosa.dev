...
function AItransition(cell1, cell2, cell3) {
  ...
  this.nextframe = function () {
    ...
    if (!this.waiting) {
      ...
      this.currentX =
        this.xi +
        ((cells[cell1].posX + cellSize / 2 - this.xi) *
          (1 + sin(-PI / 2 + (PI * this.aiframe) / aiTransitionFrames))) /
          2;
      this.currentY =
        this.yi +
        ((cells[cell1].posY + cellSize / 2 - this.yi) *
          (1 + sin(-PI / 2 + (PI * this.aiframe) / aiTransitionFrames))) /
          2;
      ...
      this.currentX =
        this.xi +
        ((cells[cell2].posX + cellSize / 2 - this.xi) *
          (1 + sin(-PI / 2 + (PI * this.aiframe) / aiTransitionFrames))) /
          2;
      this.currentY =
        this.yi +
        ((cells[cell2].posY + cellSize / 2 - this.yi) *
          (1 + sin(-PI / 2 + (PI * this.aiframe) / aiTransitionFrames))) /
          2;
      ...
      this.currentX =
        this.xi +
        ((cells[cell3].posX + cellSize / 2 - this.xi) *
          (1 + sin(-PI / 2 + (PI * this.aiframe) / aiTransitionFrames))) /
          2;
      this.currentY =
        this.yi +
        ((cells[cell3].posY + cellSize / 2 - this.yi) *
          (1 + sin(-PI / 2 + (PI * this.aiframe) / aiTransitionFrames))) /
          2;
      ...
      this.currentX =
        this.xi +
        ((boardDimension - this.xi) *
          (1 + sin(-PI / 2 + (PI * this.aiframe) / aiTransitionFrames))) /
          2;
      this.currentY =
        this.yi +
        ((boardDimension / 2 - this.yi) *
          (1 + sin(-PI / 2 + (PI * this.aiframe) / aiTransitionFrames))) /
          2;
